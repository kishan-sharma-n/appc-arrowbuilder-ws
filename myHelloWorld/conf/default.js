...
module.exports = {
	...
	admin: {
		...
		validEmails: ["kishansharma.narayanan@cognizant.com"],
	...
	session: {
		...
		encryptionKey: 'qnfRGPeYiS+HuKDqujdTS8s0KgBrlEjBQuXrkro7v/s=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'I12Ds2yyP0nPEC+rqX4P/tFOH3hwzLEgiccYM+07hqYjuDQo57tT42kSEvdNk/HN97wIF86mrIx1iQVxYJaj0A==',
		secret: 'AzUOz5w0i9jWu+0LlSVkyY0tYcLE6FOk', // should be a large unguessable string
	...
	cookieSecret: '5zh5HTE5BHVXMdWeyP3xxyrm16pzuZ6y',
